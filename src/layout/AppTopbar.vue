...
<template>
    <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <!-- <div class="p-toggleswitch p-component" data-pc-name="toggleswitch" data-pc-section="root" data-p-checked="false" data-p-disabled="false" pc29="" style="position: relative">
                <input type="checkbox" role="switch" class="p-toggleswitch-input" aria-checked="false" data-pc-section="input" />
                <span class="p-toggleswitch-slider" data-pc-section="slider"></span>
            </div> -->
            <!-- лого -->
